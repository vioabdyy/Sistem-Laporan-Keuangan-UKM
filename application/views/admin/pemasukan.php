      ...
      <div class="card-body">
        ...
        <div class="input-group">
          <div class="form-outline">
            <?php echo form_open('pemasukan/search')?>
        ...
        <table id="" class="table table-bordered table-striped">
          ...
          foreach ($pemasukan as $msk) : ?>
           <tr class="text-center">
             ...
             <td><?php echo anchor('Pemasukan/edit/'.$msk->id_pemasukan,'<i style="color:#343A40;" class="fa fa-edit"></i>') ?></td>
             <td onclick="javascript:return confirm('apakah anda yakin hapus?')"><?php echo anchor('Pemasukan/hapus/'.$msk->id_pemasukan,'<i style="color:red" class="fas fa-trash"></i></a>') ?></td>
           </tr>
         <?php endforeach ?>
