...
<div class="content-wrapper">
  ...
  <div class="content-header">
    ...
    <div class="card">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="margin-bottom: 10px;">+ Tambah Modal
        </button>
        <table id="" class="table table-bordered table-striped">
          ...
          foreach ($modal as $mdl) : ?>
           <tr class="text-center">
             ...
             <td onclick="javascript:return confirm('apakah anda yakin hapus?')"><?php echo anchor('Modal/hapus/'.$mdl->id_modal,'<i style="color:red" class="fas fa-trash"></i></a>') ?></td>
             <td><?php echo anchor('Modal/edit/'.$mdl->id_modal,'<i style="color:yellow;" class="fa fa-edit"></i>') ?></td>
           </tr>
         <?php endforeach ?>
       </table>
     </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?php echo base_url().'Modal/tambah_aksi'; ?> ">
