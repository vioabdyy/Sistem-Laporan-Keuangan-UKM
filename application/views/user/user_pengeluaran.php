			...
			<div class="card-body">
				...
				<div class="input-group">
					<div class="form-outline">
						<?php echo form_open('User_pengeluaran/search')?>
				...
				<table id="" class="table table-bordered table-striped">
					...
					foreach ($pengeluaran as $luar) : ?>
						<tr class="text-center">
							...
							<td><?php echo anchor('User_pengeluaran/edit/'.$luar->id_pengeluaran,'<i style="color:#343A40;" class="fa fa-edit"></i>') ?></td>
							<td onclick="javascript:return confirm('apakah anda yakin hapus?')"><?php echo anchor('User_pengeluaran/hapus/'.$luar->id_pengeluaran,'<i style="color:red" class="fas fa-trash"></i></a>') ?></td></button>
						</tr>
						
					<?php endforeach ?>
					<tr class="text-center">
						<td calspan="3" rowspan="2" style="padding: 25px;"></td>
						<td style="padding: 25px;"><b>Nilai Pengeluaran</b></td>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form method="post" action="<?php echo base_url().'User_pengeluaran/tambah_aksi'; ?> ">
